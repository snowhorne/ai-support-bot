...
.dijon-avatar { width:28px; height:28px; border-radius:50%; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#fff; flex:0 0 28px; }
...
.dijon-msg { max-width: 80%; padding:12px 14px; border-radius: 16px; font-size: 15px; line-height: 1.45; word-break: break-word; }
...
export default function ChatWidget() {
  ...
  // Keep focus after every message render
  useEffect(() => {
